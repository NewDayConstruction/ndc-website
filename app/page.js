...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
          ...
          {[
            {
              title: "HVAC",
              base: "/projects/hvac",
              // Replace with the exact filenames you’ve uploaded under /public/projects/hvac
              files: ["hvac1.jpg", "hvac2.jpg"],
            },
            {
              title: "Solar",
              base: "/projects/solar",
              files: ["solar1.jpg", "solar2.jpg"],
            },
            {
              title: "Construction",
              base: "/projects/construction",
              files: ["construction1.jpg", "construction2.jpg"],
            },
          ].map((cat, idx) => (
      ...
      {/* Projects (optional placeholder section) */}
